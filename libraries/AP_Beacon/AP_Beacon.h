...
private:
    ...
    AP_Vector3f beacon1_pos;
    AP_Vector3f beacon2_pos;
    AP_Vector3f beacon3_pos;
    AP_Vector3f beacon4_pos;
    AP_Vector3f beacon5_pos;
    AP_Vector3f beacon6_pos;
    AP_Vector3f beacon7_pos;
