...
private:
    ...
    AP_Float beacon1_posx;
    AP_Float beacon1_posy;
    AP_Float beacon1_posz;
    AP_Float beacon2_posx;
    AP_Float beacon2_posy;
    AP_Float beacon2_posz;
    AP_Float beacon3_posx;
    AP_Float beacon3_posy;
    AP_Float beacon3_posz;
    AP_Float beacon4_posx;
    AP_Float beacon4_posy;
    AP_Float beacon4_posz;
    AP_Float beacon5_posx;
    AP_Float beacon5_posy;
    AP_Float beacon5_posz;
    AP_Float beacon6_posx;
    AP_Float beacon6_posy;
    AP_Float beacon6_posz;
    AP_Float beacon7_posx;
    AP_Float beacon7_posy;
    AP_Float beacon7_posz;
