...
const AP_Param::GroupInfo AP_Beacon::var_info[] = {
    ...
    // @Param: _BEACON1_POS
    // @DisplayName: Beacon 1 position
    // @Description: Beacon 1 position
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BEACON1_POS", 5, AP_Beacon, beacon1_pos, 0),
    
        // @Param: _BEACON2_POS
    // @DisplayName: Beacon 2 position
    // @Description: Beacon 2 position
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BEACON2_POS", 6, AP_Beacon, beacon2_pos, 0),
    
        // @Param: _BEACON3_POS
    // @DisplayName: Beacon 3 position
    // @Description: Beacon 3 position
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BEACON3_POS", 7, AP_Beacon, beacon3_pos, 0),
    
        // @Param: _BEACON4_POS
    // @DisplayName: Beacon 4 position
    // @Description: Beacon 4 position
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BEACON4_POS", 8, AP_Beacon, beacon4_pos, 0),
    
        // @Param: _BEACON5_POS
    // @DisplayName: Beacon 5 position
    // @Description: Beacon 5 position
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BEACON5_POS", 9, AP_Beacon, beacon5_pos, 0),

    // @Param: _BEACON6_POS
    // @DisplayName: Beacon 6 position
    // @Description: Beacon 6 position
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BEACON6_POS", 10, AP_Beacon, beacon6_pos, 0),
    
    // @Param: _BEACON7_POS
    // @DisplayName: Beacon 7 position
    // @Description: Beacon 7 position
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BEACON7_POS", 11, AP_Beacon, beacon7_pos, 0),
