...
const AP_Param::GroupInfo AP_Beacon::var_info[] = {
    ...
    // @Param: _BCN1_X
    // @DisplayName: Beacon 1 position x
    // @Description: Beacon 1 position x
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN1_X", 5, AP_Beacon, beacon1_posx, 0),

    // @Param: _BCN1_Y
    // @DisplayName: Beacon 1 position y
    // @Description: Beacon 1 position y
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN1_Y", 6, AP_Beacon, beacon1_posy, 0),

    // @Param: _BCN1_Z
    // @DisplayName: Beacon 1 position z
    // @Description: Beacon 1 position z
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN1_Z", 7, AP_Beacon, beacon1_posz, 0),
    
    // @Param: _BCN2_X
    // @DisplayName: Beacon 2 position x
    // @Description: Beacon 2 position x
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN2_X", 8, AP_Beacon, beacon2_posx, 0),

    // @Param: _BCN2_Y
    // @DisplayName: Beacon 2 position y
    // @Description: Beacon 2 position y
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN2_Y", 9, AP_Beacon, beacon2_posy, 0),

    // @Param: _BCN2_Z
    // @DisplayName: Beacon 2 position z
    // @Description: Beacon 2 position z
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN2_Z", 10, AP_Beacon, beacon2_posz, 0),

    // @Param: _BCN3_X
    // @DisplayName: Beacon 3 position x
    // @Description: Beacon 3 position x
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN3_X", 11, AP_Beacon, beacon3_posx, 0),

    // @Param: _BCN3_Y
    // @DisplayName: Beacon 3 position y
    // @Description: Beacon 3 position y
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN3_Y", 12, AP_Beacon, beacon3_posy, 0),

    // @Param: _BCN3_Z
    // @DisplayName: Beacon 3 position z
    // @Description: Beacon 3 position z
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN3_Z", 13, AP_Beacon, beacon3_posz, 0),

    // @Param: _BCN4_X
    // @DisplayName: Beacon 4 position x
    // @Description: Beacon 4 position x
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN4_X", 14, AP_Beacon, beacon4_posx, 0),

    // @Param: _BCN4_Y
    // @DisplayName: Beacon 4 position y
    // @Description: Beacon 4 position y
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN4_Y", 15, AP_Beacon, beacon4_posy, 0),

    // @Param: _BCN4_Z
    // @DisplayName: Beacon 4 position z
    // @Description: Beacon 4 position z
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN4_Z", 16, AP_Beacon, beacon4_posz, 0),

    // @Param: _BCN5_X
    // @DisplayName: Beacon 5 position x
    // @Description: Beacon 5 position x
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN5_X", 17, AP_Beacon, beacon5_posx, 0),

    // @Param: _BCN5_Y
    // @DisplayName: Beacon 5 position y
    // @Description: Beacon 5 position y
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN5_Y", 18, AP_Beacon, beacon5_posy, 0),

    // @Param: _BCN5_Z
    // @DisplayName: Beacon 5 position z
    // @Description: Beacon 5 position z
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN5_Z", 19, AP_Beacon, beacon5_posz, 0),

    // @Param: _BCN6_X
    // @DisplayName: Beacon 6 position x
    // @Description: Beacon 6 position x
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN6_X", 20, AP_Beacon, beacon6_posx, 0),

    // @Param: _BCN6_Y
    // @DisplayName: Beacon 6 position y
    // @Description: Beacon 6 position y
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN6_Y", 21, AP_Beacon, beacon6_posy, 0),

    // @Param: _BCN6_Z
    // @DisplayName: Beacon 6 position z
    // @Description: Beacon 6 position z
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN6_Z", 22, AP_Beacon, beacon6_posz, 0),

    // @Param: _BCN7_X
    // @DisplayName: Beacon 7 position x
    // @Description: Beacon 7 position x
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN7_X", 23, AP_Beacon, beacon7_posx, 0),

    // @Param: _BCN7_Y
    // @DisplayName: Beacon 7 position y
    // @Description: Beacon 7 position y
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN7_Y", 24, AP_Beacon, beacon7_posy, 0),

    // @Param: _BCN7_Z
    // @DisplayName: Beacon 7 position z
    // @Description: Beacon 7 position z
    // @Units: meters
    // @Increment: -
    // @Range: -
    // @User: Advanced
    AP_GROUPINFO("_BCN7_Z", 25, AP_Beacon, beacon7_posz, 0),
