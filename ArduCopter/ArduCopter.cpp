...
#include "Copter.h"
#include <AP_TDoA/AP_TDoA.cpp>  //  I know this shouldn't be here, I'll worry about this later. (Doesn't find function definitions w/o this)
...
const AP_Scheduler::Task Copter::scheduler_tasks[] = {
    ...
    SCHED_TASK(tdoa,                  1,      300),
    SCHED_TASK(tdoa1,                 400,    100),
    SCHED_TASK(tdoa2,                 400,    100),
    SCHED_TASK(tdoa3,                 400,    100),
#if OPTFLOW == ENABLED
